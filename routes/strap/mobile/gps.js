...
/**
 * @api {post} /id/:id Post the location details from GPS
 * @apiVersion 1.0.0
 * @apiName pickLoc
 * @apiGroup mobile
 * @apiPermission none
 *
 * @apiDescription This function is used to Post the GPS coordinates from device.
 */
...
/**
 * @api {get} /id/:id Get location details from GPS
 * @apiVersion 1.0.0
 * @apiName getLoc
 * @apiGroup mobile
 * @apiPermission none
 *
 * @apiDescription This function is used to get the GPS coordinates from device.
 */
